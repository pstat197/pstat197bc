...
The report should be no less than 5 pages and no more than 10 pages (not including figures or tables). If necessary, you can include supplementary material or appendices following the main body of the report or as separate files/documents.
...
All figures and tables should be labeled and captioned, *e.g.*, "**Fig. 1:** map of sampling locations in 2020".
...
Upload your PDF report and any supplementary files to this [Drive folder](https://drive.google.com/drive/folders/1SE8uk3J6IWrzHhzRelKyIUmsoeqSBdZF?usp=sharing). Use the naming conventions:

-   report document: `TEAM_NAME-interim-report-w26.pdf`

-   copies of figures from the report: `img/TEAM_NAME-fig1.png` (filename should match figure label in document) --\>

-   supplementary material: `TEAM_NAME-[description].[extension]`
